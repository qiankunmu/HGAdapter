...
from transformers import Qwen2Tokenizer, GenerationConfig
import numpy as np
...
from models.Qwen2HGAdapterModels import MyQwen2HGAdapterForCausalLM
...
def main():
    ...
    tokenizer = Qwen2Tokenizer.from_pretrained(pretrain_model_name_or_path)
